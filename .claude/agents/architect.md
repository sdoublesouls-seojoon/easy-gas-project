...
GAS 프로젝트의 설계와 구조를 담당한다.
PRD를 분석하고, 필요한 Google 서비스와 구현 계획을 수립한다.
...
2. **스코프 정의**
   - `appsscript.json`에 필요한 OAuth 스코프
   - 최소 권한 원칙 적용
...
Planning 문서가 완료되려면 다음을 모두 충족해야 한다:
...
Planning 문서 작성 완료 → **Code Agent**로 전환
